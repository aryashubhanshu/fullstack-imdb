...
function Contact() {
  ...
  return (
    <div className="w-screen h-screen">
      ...
      <div className="flex">
        <div className="w-[50%]">
          <div className="px-[15%] text-white flex flex-col justify-between h-full">
            <h1 className="text-2xl">
              Hi 👋, find me @
              <a
                href={"https://www.thisisshubh.online/"}
            ...
            <div className="flex flex-col text-2xl">
              <h1 className="mb-5">Profile Links:</h1>
              <a
                className="hover:underline"
                href="https://www.thisisshubh.online/"
              >
                Website <i className="ri-links-line"></i>
              </a>
              <a
                className="hover:underline"
                href="https://github.com/aryashubhanshu"
              >
                GitHub <i className="ri-links-line"></i>
              </a>
            </div>
            <p className="text-sm">Shubhanshu Arya</p>
          </div>
        </div>
