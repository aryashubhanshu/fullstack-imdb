...
function TvDetails() {
  ...
  return info ? (
    <div
      style={{
        background: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,1), rgba(0,0,0,1)), url(https://image.tmdb.org/t/p/original/${info.detail.backdrop_path})`,
        backgroundPosition: "center top",
        backgroundSize: "contain",
        backgroundRepeat: "no-repeat",
      }}
      className="relative w-screen h-[200vh] px-[5%]"
    >
      {/* Part 1 Navigation */}
      ...
      <div className="w-[100%] flex overflow-y-hidden mb-5 p-5">
        {info.detail.seasons.length > 0 ? (
          info.detail.seasons.map((s, ind) => (
            <div key={ind} className="w-[10vw] mr-[2%]">
              <img
                className="h-[30vh] min-w-[10vw] object-cover shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)]"
